<script lang="ts">
  ...
  onMount(() => {
    // DEV mode: always use fake results immediately
    ...
    // If Pagefind is already loaded, initialize immediately
    ...
    // Fallback: check if pagefind loaded after a delay
    setTimeout(() => {
      if (!initialized) {
